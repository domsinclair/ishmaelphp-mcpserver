            ...
            [
                ...
                'content' => [
                    ...
                    'text' => "When working with the IshmaelPHP framework, please follow these best practices:\n\n" .
                        ...
                        "9. **Event-Driven Decoupling**: Use the Ishmael Event Bus to decouple modules. Prefer **Typed Event Classes** (scaffolded via `ish:make:event`) and declare them in the module's `emits` manifest. Listeners should be scaffolded via `ish:make:listener` and registered in the `listeners` block of `module.php`. This ensures type safety and discoverability via `ish:events:list`."
                ]
            ]
        ];
    }
